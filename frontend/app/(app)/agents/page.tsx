...
export default function AgentsPage() {
  return (
    <section className="page page-wide">
      ...
      <div className="grid grid-3" style={{ gap: "32px", alignItems: "start", marginBottom: "32px" }}>
        ...
        <div>
          <ImagePlaceholder label="Orchestration agent sequence flow diagram" height="340px" />
        </div>
      </div>
    </section>
  );
